...
import unificationIconBoth from 'shared-utils/assets/icons/unification-both.svg?url';
...
import unificationLogoLight from 'shared-utils/assets/logos/unification-light.png';
import unificationLogoDark from 'shared-utils/assets/logos/unification-dark.png';
...
const ChainIcon = ({
  ...
  switch (chainName) {
    ...
    case 'unification':
      [iconDark, iconLight] =
        type === 'icon'
          ? [unificationIconBoth, unificationIconBoth]
          : [unificationLogoDark, unificationLogoLight];
      break;
    default:
